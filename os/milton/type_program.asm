...
;        (AH=4Ch: AL=exit code); spec/memory_map.h (PROGRAM_IMAGE = 0x00020100).
...
; Embedded:  bin2c -> a C .rodata array; the loader copies it to 0x20100 and JMPs.
;
; ADDRESSING (Solution A): assembled at org 0x00020100 == PROGRAM_IMAGE so the
