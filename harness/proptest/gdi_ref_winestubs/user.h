/* harness/proptest/gdi_ref_winestubs/user.h -- EMPTY host-only stub.
 * The wine server/region.c #includes the wine server headers (user.h and peers).
...
#ifndef GDI_REF_WINESTUB_USER_H
#define GDI_REF_WINESTUB_USER_H
#endif
