/* harness/proptest/gdi_ref_winestubs/request.h -- EMPTY host-only stub.
 * The wine server/region.c #includes the wine server headers (request.h and peers).
...
#ifndef GDI_REF_WINESTUB_REQUEST_H
#define GDI_REF_WINESTUB_REQUEST_H
#endif
