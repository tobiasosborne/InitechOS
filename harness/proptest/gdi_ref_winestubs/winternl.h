/* harness/proptest/gdi_ref_winestubs/winternl.h -- EMPTY host-only stub.
 * The wine server/region.c #includes the wine server headers (winternl.h and peers).
...
#ifndef GDI_REF_WINESTUB_WINTERNL_H
#define GDI_REF_WINESTUB_WINTERNL_H
#endif
