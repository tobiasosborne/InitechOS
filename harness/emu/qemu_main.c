...
static void usage(const char *argv0)
{
    fprintf(stderr,
        ...
        "                     \"d,i,r,ret\" (letters/digits, ret, spc); a token\n"
        "                     may be a CHORD, e.g. \"ctrl-n\" (one send-key with\n"
        "                     both qcodes pressed together)\n"
        ...
        "                     \"k<chord>\" one keystroke IN STREAM ORDER, e.g.\n"
        "                     \"kctrl-n\" (the only way to key AFTER a click)\n"
